    ...
    public partial class Window1 : Window
    {
        ...
        private void button1_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (factory == null)
                {
                    factory = new ChannelFactory<IContactManager>(binding, new EndpointAddress(address));
                ...
                if (factory != null && channel != null)
                {
                    ...
                    {
                        textBox1.Text += "->" + contacts[i].FirstName + " " + contacts[i].LastName + Environment.NewLine; ;
                    }
                }
            }
            catch (Exception ex)
